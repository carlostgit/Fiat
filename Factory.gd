...
export(NodePath) var _shop_node_path

var _production_rate = 1

var _owned_products:float = 0
var _products_in_market:float = 1
...
func set_money_in_market(amount_arg:float):
	...
	self._shop.update_money_in_market()
...
##	_shop.send_money_to_government(amount_arg)
#	_shop.transfer_money(amount_arg,self,self._government)
